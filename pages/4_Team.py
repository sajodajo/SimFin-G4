...
with col3:
    ...
    st.write('Results-driven Data Engineer with telecom and IT experience in network infrastructure, data pipelines, and workflow optimization. Skilled in Python, SQL, MongoDB, Spark, and data visualization (Power BI, Tableau). Currently pursuing a Master’s in Business Analytics and Data Science at IE University.')

# Column 4
with col4:
    st.image('Media/waldo.jpeg', use_container_width=True)
    st.subheader(' 🇪🇸 Waldo Barreto')
    st.write("Economist currently pursuing a master's in Data Science and Business Analytics, with a strong work ethic, and thrive on leveraging analytical skills to solve complex business problems. Deeply committed to continuous learning and growth, always seeking new opportunities to expand expertise.")
